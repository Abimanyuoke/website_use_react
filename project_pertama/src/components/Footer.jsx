const Footer = () => {
  return (
    <div className="footer bg-white shadow mt-2 md:flex block container md:mx-auto" id="footer">
      ...
      <div className="social-footer flex items-center gap-7 justify-center pb-6 md:pb-0">
